...
// First listing = the hero feature; next 6 fill the supporting grid.
const FEATURE = PORTFOLIO[0]
const SUPPORTING = PORTFOLIO.slice(1, 7)
  ...
  return (
    <section ref={sectionRef} className="py-section bg-charcoal-950 relative overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        {/* HERO LISTING — full bleed, parallax, prominent CTA */}
        <motion.div
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="lg:col-span-3 relative h-80 md:h-96 lg:h-[520px] overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6 flex gap-2">
                    <Badge variant="teal">{FEATURE.status}</Badge>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-px bg-charcoal-800/80 mb-8">
                      ...
                      <div className="bg-charcoal-900 px-5 py-4">
                        ...
                        <p className="text-sm text-cream-100">{FEATURE.type}</p>
                      </div>
                      <div className="bg-charcoal-900 px-5 py-4">
                        <p className="font-mono text-[9px] tracking-[0.3em] uppercase text-charcoal-500 mb-1.5">
                          Status
                        </p>
                        <p className="text-sm text-cream-100">{FEATURE.status}</p>
                      </div>
                    </div>
        ...
        {/* SUPPORTING GRID — denser, more inventory feel */}
